...
public class SuperRandomEnemy extends GameObject {
	...
	public SuperRandomEnemy(int x, int y, ID id, Handler handler) {
		super(x, y, id);
	...
	public void tick() {
		...
		//2% chance to completely change velocity every tick
